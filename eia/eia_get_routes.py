''' get routes from eia api endpoint '''
# pylint: disable=C0103,W0311,C0301
...
rx = requests.get(api + api_key, timeout=requests_timeout)
...
if j:
  ...
  if routes:
    ...
    for route in routes:
      ...
      r0 = requests.get(api + route + api_key, timeout=requests_timeout)
      ...
      for rx0 in rr0:
        ...
        print(count0, count1, count2, count3, count4, count5, count6, ' - routes_found: ', count7)
        r1 = requests.get(api + route1 + api_key, timeout=requests_timeout)
        ...
        for rx1 in rr1:
          ...
          print(count0, count1, count2, count3, count4, count5, count6, ' - routes_found: ', count7)
          r2 = requests.get(api + route2 + api_key, timeout=requests_timeout)
          ...
          for rx2 in rr2:
            ...
            print(count0, count1, count2, count3, count4, count5, count6, ' - routes_found: ', count7)
            r3 = requests.get(api + route3 + api_key, timeout=requests_timeout)
            ...
            for rx3 in rr3:
              ...
              print(count0, count1, count2, count3, count4, count5, count6, ' - routes_found: ', count7)
              r4 = requests.get(api + route4 + api_key, timeout=requests_timeout)
              ...
              for rx4 in rr4:
                ...
                print(count0, count1, count2, count3, count4, count5, count6, ' - routes_found: ', count7)
                r5 = requests.get(api + route5 + api_key, timeout=requests_timeout)
